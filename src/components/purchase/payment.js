  ...
  function processPayment() {
    ...
    const tokenizationSpecification = {
      ...
      parameters: {
        gateway: "stripe",
        "stripe:version": "v3",
        "stripe:publishableKey": "pk_test_51KglP9SDdngX88ejwOL0MwEuLGTlxGR6EArzJlpcczFKMDxk5Mhs3MZX6ZHI6Echuh3MqPuLQzkUVFozlh6Jsip000qnJVR410"
      }
    };
    ...
    const cardPaymentMethod = {
      ...
      const transactionInfo = {
        ...
        totalPrice: props.price.toString(),
        currencyCode: "USD"
      };
